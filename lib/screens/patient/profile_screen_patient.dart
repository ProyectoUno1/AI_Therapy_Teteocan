  ...
  Widget _buildSubscriptionCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color(0xFFFFF9C4), // Un amarillo claro para resaltar
            ...
            child: ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Iniciando prueba de 3 días')),
                );
              },
              style: ElevatedButton.styleFrom(
  ...
  Widget _buildThemeOption(
    ...
    return InkWell(
      onTap: () {
        ...
        // Por ejemplo, usando Provider o un ThemeController
        ScaffoldMessenger.of(
          context,

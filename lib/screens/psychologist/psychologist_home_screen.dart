...
import 'package:ai_therapy_teteocan/screens/psychologist/profile_screen_psychologist.dart';
...
class _PsychologistHomeScreenState extends State<PsychologistHomeScreen> {
  ...
  static List<Widget> _widgetOptions = <Widget>[
    ...
    ProfileScreenPsychologist(), // La pantalla de perfil ya creada
  ];
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: Icon(
              Icons.dashboard,
            ), // Icono más apropiado para un panel de control
            label: 'Panel',
          ),
          BottomNavigationBarItem(icon: Icon(Icons.chat), label: 'Chats'),
          BottomNavigationBarItem(
            icon: Icon(Icons.handyman), // Icono para herramientas
            label: 'Herramientas',
          ),

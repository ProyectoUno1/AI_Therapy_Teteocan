...
class _PsychologistChatListScreenState
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Column(
        children: [
          // TabBar similar al de pacientes
          Container(
          ...
          Expanded(
            child: TabBarView(
              children: [_buildPatientsChat(), _buildAIAssistantChat()],
            ),
          ),
        ],
      ),
  ...
  Widget _buildAIAssistantChat() {
    return Container(
      color: Theme.of(context).cardColor,
      child: Column(
        children: [
          // Card de Aurora AI para psicólogos
          ListTile(
            contentPadding: const EdgeInsets.symmetric(
              horizontal: 16,
              vertical: 8,
            ...
            leading: CircleAvatar(
              ...
              child: Icon(Icons.psychology, color: AppConstants.primaryColor),
            ),
            title: const Text(
              'Aurora AI - Asistente Profesional',
              style: TextStyle(
            ...
            subtitle: const Text(
              'Consultas profesionales y recursos terapéuticos',
              style: TextStyle(fontFamily: 'Poppins'),
            ),
            trailing: Container(
            ...
            onTap: () {
              // TODO: Navegar a chat con Aurora AI para psicólogos
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Aurora AI para psicólogos próximamente'),
                ),
              );
            },
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Consulta recursos terapéuticos, técnicas de intervención y obtén sugerencias profesionales',

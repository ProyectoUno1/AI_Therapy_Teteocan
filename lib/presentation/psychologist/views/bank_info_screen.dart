      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: const [
              Tab(icon: Icon(Icons.account_balance_wallet_outlined), text: 'Datos Bancarios'),
            ...
            children: [
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _selectedAccountType == 'checking' ? lightAccentColor : Colors.transparent,
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                size: 18,
                                color: _selectedAccountType == 'checking' ? Colors.white : Colors.grey[600],
                              ),
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(vertical: 12),
                          decoration: BoxDecoration(
                            color: _selectedAccountType == 'savings' ? lightAccentColor : Colors.transparent,
                            borderRadius: const BorderRadius.only(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                size: 18,
                                color: _selectedAccountType == 'savings' ? Colors.white : Colors.grey[600],
                              ),
                              const SizedBox(width: 8),
                              Text(
                                'Ahorro',
                ...
                child: Row(
                  children: [
                    ...
                    Switch(
                      ...
                      onChanged: (value) => setState(() => _hasInternationalAccount = value),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: state.status == BankInfoStatus.loading ? null : _saveBankInfo,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 11, color: Colors.green.shade700, fontFamily: 'Poppins'),
                      ),
                    ),
                  ],
                ),
              ...
              children: [
                Expanded(
                  child: _buildSummaryCard(
                    title: 'Total Ganado',
                    amount: '\$${state.totalEarned.toStringAsFixed(2)}', // ✅ Interpolación correcta
                ...
                Expanded(
                  child: _buildSummaryCard(
                    title: 'Pendiente',
                    amount: '\$${state.pendingAmount.toStringAsFixed(2)}', // ✅ Interpolación correcta
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildDetailRow('Paciente:', payment.patientName),
              _buildDetailRow('Fecha:', _formatDate(payment.date)),
          ...
          content: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Todos', style: TextStyle(fontFamily: 'Poppins')),
                onTap: () {
              ...
              ListTile(
                ...
                title: const Text('Completados', style: TextStyle(fontFamily: 'Poppins')),
                onTap: () {
              ...
              ListTile(
                ...
                title: const Text('Pendientes', style: TextStyle(fontFamily: 'Poppins')),
                onTap: () {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: Text('Entendido', style: TextStyle(color: accentColor, fontFamily: 'Poppins')),
              onPressed: () => Navigator.of(context).pop(),
            ),
          ],
        );
